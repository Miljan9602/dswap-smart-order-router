...
interface IDragonswapFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IDragonswapFactory extends BaseContract {
  ...
  interface: IDragonswapFactoryInterface;
