...
interface DragonswapFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export type FeeToSetEvent = TypedEvent<[string] & { feeTo: string }>;

export type FeeToSetterSetEvent = TypedEvent<
  [string] & { feeToSetter: string }
>;
...
export class DragonswapFactory extends BaseContract {
  ...
  interface: DragonswapFactoryInterface;
  ...
  filters: {
    ...
    "PairCreated(address,address,address,uint256)"(
      ...
      [string, string, string, BigNumber],
      { token0: string; token1: string; pair: string; length: BigNumber }
    >;
