...
interface IDragonswapRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class IDragonswapRouter extends BaseContract {
  ...
  interface: IDragonswapRouterInterface;
