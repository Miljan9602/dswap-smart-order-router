...
interface IDragonswapV2PoolInterface extends ethers.utils.Interface {
  functions: {
...
export class IDragonswapV2Pool extends BaseContract {
  ...
  interface: IDragonswapV2PoolInterface;
