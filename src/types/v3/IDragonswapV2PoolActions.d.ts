...
interface IDragonswapV2PoolActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class IDragonswapV2PoolActions extends BaseContract {
  ...
  interface: IDragonswapV2PoolActionsInterface;
