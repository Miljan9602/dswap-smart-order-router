...
interface IDragonswapV2PoolStateInterface extends ethers.utils.Interface {
  functions: {
...
export class IDragonswapV2PoolState extends BaseContract {
  ...
  interface: IDragonswapV2PoolStateInterface;
