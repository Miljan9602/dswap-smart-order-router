...
interface IDragonswapV2FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IDragonswapV2Factory extends BaseContract {
  ...
  interface: IDragonswapV2FactoryInterface;
