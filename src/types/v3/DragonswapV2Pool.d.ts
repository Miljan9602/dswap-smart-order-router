...
interface DragonswapV2PoolInterface extends ethers.utils.Interface {
  functions: {
...
export class DragonswapV2Pool extends BaseContract {
  ...
  interface: DragonswapV2PoolInterface;
