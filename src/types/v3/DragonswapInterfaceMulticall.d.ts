...
interface DragonswapInterfaceMulticallInterface extends ethers.utils.Interface {
  functions: {
...
export class DragonswapInterfaceMulticall extends BaseContract {
  ...
  interface: DragonswapInterfaceMulticallInterface;
