...
interface DragonswapV2FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class DragonswapV2Factory extends BaseContract {
  ...
  interface: DragonswapV2FactoryInterface;
